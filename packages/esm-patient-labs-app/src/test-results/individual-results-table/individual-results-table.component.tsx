...
import { showModal, useLayoutType, isDesktop } from '@openmrs/esm-framework';
import { CardHeader, getPatientUuidFromUrl, type OBSERVATION_INTERPRETATION } from '@openmrs/esm-patient-common-lib';
